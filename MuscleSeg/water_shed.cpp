...
namespace bici2
{
    int allocWSNodes(std::vector<WSNode>& storage)
    {
    ...
    void WaterShedSeg(cv::Mat& _src, cv::Mat& _markers)
    {
        // Labels for pixels
...
#define c_diff(ptr1,ptr2,diff)           \
        ...
        for (;;)
        {
            ...
            {
                c_diff(ptr, ptr - istep - 3, t);
                ws_push(t, mofs - mstep - 1, iofs - istep - 3);
